...
export const CANNON_TOWER_LEVELS: TowerConfig[] = [
  ...
  {
    type: TowerType.Cannon, name: "Cannon", damage: 145, range: 2.6,
...
export const LIGHTNING_TOWER_LEVELS: TowerConfig[] = [
  ...
  },
  {
    ...
    chainCount: 3, chainRange: 2.3, chainDamageFalloff: 0.75, upgradeCost: 80,
  },
  {
    ...
    chainCount: 4, chainRange: 2.6, chainDamageFalloff: 0.75,
  },
];
...
export const POISON_TOWER_LEVELS: TowerConfig[] = [
  ...
  },
  {
    ...
    poisonDamage: 12, poisonDuration: 5.0, poisonTickRate: 0.5, poisonMaxStacks: 6,
  },
];
...
export const SNIPER_TOWER_LEVELS: TowerConfig[] = [
  {
    ...
    fireRate: 0.3, cost: 65, projectileSpeed: 12, projectileColor: 0xecf0f1,
    upgradeCost: 55,
  },
  {
    type: TowerType.Sniper, name: "Sniper", damage: 170, range: 5.5,
    fireRate: 0.35, cost: 65, projectileSpeed: 12, projectileColor: 0xecf0f1,
    upgradeCost: 80,
  },
  {
    type: TowerType.Sniper, name: "Sniper", damage: 250, range: 6.0,
    fireRate: 0.4, cost: 65, projectileSpeed: 12, projectileColor: 0xecf0f1,
  },
];
